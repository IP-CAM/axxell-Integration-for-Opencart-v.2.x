        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-axxell"
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-status"><?php echo $entry_enginetype; ?></label>
                        <div class="col-sm-10">
                            <select name="enginetype" id="input-status" class="form-control">
                                <option value="<?php echo $text_engine_personalized; ?>" <?php echo $selected_engine_personalized; ?>><?php echo $text_engine_personalized; ?></option>
                                <option value="<?php echo $text_engine_similar; ?>" <?php echo $selected_engine_similar; ?>><?php echo $text_engine_similar; ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
